...
class AdminReadPickupsController extends StatefulWidget {
  @override
  _AdminReadPickupsControllerState createState() => _AdminReadPickupsControllerState();

  fetchPickups(BuildContext context) {}
}

class _AdminReadPickupsControllerState extends State<AdminReadPickupsController> {
